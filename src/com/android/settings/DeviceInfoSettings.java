...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_PIXELDUST_VERSION = "pixeldust_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_PIXELDUST_VERSION, "ro.pixeldust.version");
        findPreference(KEY_PIXELDUST_VERSION).setEnabled(true);
